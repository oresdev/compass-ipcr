...
var (
	...
	commands = &cobra.Command{
		Use:           "compass-ipcr",
		Short:         "compass-ipcr – command-line tool for Compass Image-Processor",
		Long:          `Compass Image-Processor is a CLI microservice that extends the capabilities of image processing. Use this tool to automatically decode / compress PNG and JPEG files and then convert them to WEBP and JPG formats.`,
		Version:       "1.0.0",
		SilenceErrors: true,
		SilenceUsage:  true,
	}
